...
const ArrowUpIcon = () => (
  ...
  >
    <path
      d="M1.3551 6.212L4.83672 2.58L4.86164 24L6.7783 24L6.75339 2.593L10.2226 6.213L11.5776 4.8L7.82193 0.881002C7.55495 0.602373 7.238 0.381347 6.88915 0.230552C6.54031 0.0797573 6.16642 0.00214148 5.78883 0.00214145C5.41123 0.00214141 5.03734 0.0797571 4.6885 0.230552C4.33966 0.381347 4.0227 0.602372 3.75572 0.881002L1.21689e-05 4.8L1.3551 6.212Z"
      fill="#4B9D65"
    />
  </svg>
);
...
const SortIcon = () => (
  ...
  >
    <path
      d="M6.5 9.25L0.00480864 0.812499L12.9952 0.812498L6.5 9.25Z"
      fill="#858585"
    />
  </svg>
);
  ...
  return (
    <div className="min-h-screen bg-white font-['Roboto']">
      ...
      <div className="w-full h-[60px] bg-waltura-primary flex items-center px-8">
        <div className="text-white text-xl font-bold tracking-wide">ALTURA</div>
      ...
      <div className="w-full h-12 bg-waltura-tertiary flex items-center px-4 md:px-8 overflow-x-auto">
        <div className="bg-waltura-secondary h-12 px-4 md:px-8 flex items-center rounded-none whitespace-nowrap">
          <span className="text-waltura-primary font-bold text-[17px] tracking-[-0.425px]">
            Dashboard
          </span>
        </div>
        ...
        <div className="min-w-[1200px]">
          ...
          <div className="flex items-center h-[31px] border-b border-waltura-tertiary gap-[23px]">
            <div className="w-20 px-3 bg-waltura-secondary h-full flex items-center justify-between">
              <span className="text-waltura-gray-medium font-bold text-[14px] tracking-[-0.35px]">
                Item
              </span>
              <SortIcon />
            </div>
          ...
          {inspectionData.map((item) => (
            <div
              key={item.id}
              className="flex items-center h-[35px] border-b border-waltura-tertiary hover:bg-gray-50 gap-[23px]"
            >
              <div className="w-20 px-3 h-full flex items-center">
                <span className="text-waltura-gray-dark font-medium text-[14px] tracking-[-0.35px]">
                  {item.id}
                </span>
              </div>
